...
/*   Updated: 2021/06/08 13:12:46 by lbaela           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("03.1) standart PRINTF : |%.*d|\n", 5, 0);
	ft_printf("03.1) my       PRINTF : |%.*d|\n", 5, 0);
	printf("03.2) standart PRINTF : |%.d|\n", 0);
	ft_printf("03.2) my       PRINTF : |%.d|\n", 0);
	printf("04) standart PRINTF : |%*.3s|\n", 0, "42");
	ft_printf("04) my       PRINTF : |%*.3s|\n\n", 0, "42");
